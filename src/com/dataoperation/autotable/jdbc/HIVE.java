...
public class HIVE implements JDBC {
    private String IP;
    private int PORT;
    private String USER;
    ...
    public HIVE(DatabaConnectBean bean) {
    	this.IP=bean.getIP();
    ...
    public Connection getConn(String DATABASE) throws ClassNotFoundException, SQLException {
        ...
        URL = "jdbc:hive2://"+IP+":"+PORT+"/"+DATABASE+"?useUnicode=true&characterEncoding=utf-8&useSSL=false&serverTimezone=UTC";
        //1.加载驱动程序
        Class.forName("org.apache.hive.jdbc.HiveDriver");
	        conn = DriverManager.getConnection(URL, USER, PASSWORD);
        //2.获得数据库链接
